                                ...
                                @foreach ($users as $key => $user)
                                    <tr id="target_{{ $user->id }}">
                                        ...
                                        <td style="min-width: 135px !important; " class="d-flex">
                                            ...
                                            <button title="Click to Update appointment" class="btn btn-warning btn-sm editappointmentBtn" id="userapprove" data-toggle="modal" data-target="#user-approve{{$user->id}}" data-id="{{ $user->id }}"><i class="fe fe-pencil"></i> approve</button>

                                            <button title="Click to Delete appointment" type="button" class="btn btn-danger btn-sm appointmentDelete" id="userdisapprove" data-toggle="modal" data-target="#user-disapprove{{$user->id}}" data-id="{{ $user->id }}"><i class="fe fe-trash"></i> disapprove</button>
                                        </td>
                                    </tr>
                                    
                                    <!-- Modal For Deleting appointment-->
                                    <div class="modal fade" id="user-approve{{ $user->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabelappointmentdelete" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabelappointmentdelete" style="font-size: 18px !important;">User Approvel {{ $user->id }}</h5>
                                    ...
                                    <div class="modal fade" id="user-disapprove{{ $user->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabelappointmentdelete" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabelappointmentdelete" style="font-size: 18px !important;">User Disapprovel {{ $user->id }}</h5>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
